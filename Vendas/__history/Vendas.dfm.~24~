object TelaVendas: TTelaVendas
  ...
  object PnlFundo: TPanel
    ...
    object LbInformacao: TLabel
      ...
      Width = 215
      Height = 13
      Caption = '(Pressione F2 para pesquisar por um Cliente)'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object LbInformacao2: TLabel
      ...
      Width = 220
      Height = 13
      Caption = '(Pressione F2 para pesquisar por um Produto)'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object PnlTotalVendas: TPanel
      Left = 392
      Top = 423
      Width = 473
      Height = 57
      TabOrder = 2
      object EdTotalVendas: TLabel
        Left = 18
        Top = 18
        Width = 128
        Height = 19
    ...
    object EdNumVenda: TEdit
      ...
      OnMouseDown = BloquearCliqueEdit
    end
  ...
  object DSVendas: TDataSource
    DataSet = DataModule1.QryItensVenda
    Left = 808
    Top = 335
  end
end
